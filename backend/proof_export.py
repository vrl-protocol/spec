...
def export_proof_bundle(input_payload: dict[str, Any], *, packet: DeterministicTracePacket | None = None, proof: Proof | None = None) -> dict[str, Any]:
  ...
  return {
    ...
    'input_hash': resolved_packet.response.integrity.input_hash,
    'output_hash': resolved_packet.response.integrity.output_hash,
...
def verify_proof_bundle(bundle: dict[str, Any]) -> dict[str, Any]:
  try:
    ...
    expected_input_hash = packet.response.integrity.input_hash
    expected_output_hash = packet.response.integrity.output_hash
    ...
    proof_payload = deepcopy(bundle['proof'])
    ...
    return {
      ...
      'checks': ['bundle_validation_error'],
      'input_hash': '',
      'trace_hash': '',
      'circuit_hash': '',
